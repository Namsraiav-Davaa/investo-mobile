...
const AnimatedTextInput = ({
  ...
  const setContentHeight = () => {
    ...
    const internalVerticalSpaces = 10;
  ...
  const animationView = useCallback(() => {
    const sizeShow = 11 + labelFontSize + inputFontSize + 2;
    const sizeHide = 11 + labelFontSize;
    const inputAdjust = {
    ...
    <View
      style={[
        ...
        styleContent,
        {
          ...
          borderColor: isInputFocused ? COLORS.white : COLORS.transparent,
          borderWidth: isInputFocused ? 0.8 : 0,
          borderRadius: 10,
        },
      ]}
    >
